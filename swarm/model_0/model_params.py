...
MODEL_PARAMS = {'aggregationInfo': {'days': 0,
 ...
 'modelParams': {'anomalyParams': {u'anomalyCacheRecords': None,
                 ...
                 'sensorParams': {'encoders': {u'EMP_NO': {'clipInput': True,
                                                           'fieldname': 'EMP_NO',
                                                           'n': 272,
                                                           'name': 'EMP_NO',
                                                           'type': 'AdaptiveScalarEncoder',
                                                           'w': 21},
                                               u'IN_OUT_STATUS': None,
                                               u'TIME_OF_SWIPE_dayOfWeek': None,
                                               u'TIME_OF_SWIPE_timeOfDay': None,
                                               u'TIME_OF_SWIPE_weekend': None,

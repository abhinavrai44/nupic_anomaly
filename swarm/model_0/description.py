...
config ={
  ...
  'modelParams' : {'sensorParams': {'encoders': {'_classifierInput': {'fieldname': 'IN_OUT_STATUS', 'classifierOnly': True, 'type': 'SDRCategoryEncoder', 'w': 21, 'n': 121}, u'EMP_NO': {'name': 'EMP_NO', 'clipInput': True, 'n': 272, 'fieldname': 'EMP_NO', 'w': 21, 'type': 'AdaptiveScalarEncoder'}, u'TIME_OF_SWIPE_dayOfWeek': None, u'TIME_OF_SWIPE_weekend': None, u'TIME_OF_SWIPE_timeOfDay': None, u'IN_OUT_STATUS': None}}, 'spParams': {'synPermInactiveDec': 0.05015}, 'tpParams': {'minThreshold': 11, 'activationThreshold': 14, 'pamLength': 3}, 'clParams': {'alpha': 0.050050000000000004}},
